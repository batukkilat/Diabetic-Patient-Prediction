# Diabetes Prediction — Naive Bayes with Information Gain Feature Selection
...
`diabetes_data.csv` — **70,692 records, 17 features, balanced binary target** (`Diabetes`).
...
Recall consistently exceeds precision — the classifier leans toward flagging positives, which
